...
sealed class BottomNavItem( val route: String, @StringRes val titleResId: Int, val icon: ImageVector) {
    ...
    object Workout : BottomNavItem("Workout", R.string.activity_workout, Icons.Default.Build)
    object Exercise : BottomNavItem("Exercise", R.string.activity_exercise, Icons.Default.Favorite)
}